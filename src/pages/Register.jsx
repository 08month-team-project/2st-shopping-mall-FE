        ...
        <RegisterInfo>
          ...
          <ItemInfoBox>
            ...
            <ItemInfo>
              ...
              <Select name="category" id="category" onChange={handleInputChange} onKeyDown={handleKeyDown} required>
            ...
            <ItemInfo>
              ...
              <Select name="size" id="size" onChange={handleInputChange} onKeyDown={handleKeyDown} required>
            ...
            <ItemInfoScript>
              ...
              {slangError.script && <ErrorMessage>{slangError.script}</ErrorMessage>}
            </ItemInfoScript>
          </ItemInfoBox>
        </RegisterInfo>
      </Container>
